...
void process2(struct shared_data *shared, int semid)
{
    ...
    while (1)
    {
        ...
        // Always show Process 2 is waiting when not active
        ...
        else
        {
            ...
            {
                printf("Process 2: High value\n");
            }
            else
            {
                printf("Process 2: Low value\n");
            }
        }
...
void process1(struct shared_data *shared, int semid)
{
    ...
    while (1)
    {
        ...
        if (shared->random_number > 5)
        {
            printf("Process 1: High value\n");
        }
        else
        {
            printf("Process 1: Low value\n");
        }
